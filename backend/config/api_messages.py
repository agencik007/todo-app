...
class ApiMessages(str, Enum):
    ...
    AUTH_PASSWORD_TOO_SIMPLE = "AUTH_PASSWORD_TOO_SIMPLE"
    ...
    GROUP_DELETED_SUCCESS = "GROUP_DELETED_SUCCESS"
    GROUP_LIMIT_REACHED = "GROUP_LIMIT_REACHED"
    GROUP_NAME_EXISTS = "GROUP_NAME_EXISTS"
    GROUP_NO_UPDATE_PERMISSION = "GROUP_NO_UPDATE_PERMISSION"
    GROUP_NO_DELETE_PERMISSION = "GROUP_NO_DELETE_PERMISSION"
